...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center font-sans antialiased px-4">
      <div className="bg-[#0b0c10] border border-[#16171e] rounded-[24px] max-w-[440px] w-full p-10 flex flex-col items-center shadow-2xl">
        
        {/* Glowing Green Controller Box */}
        <div className="w-16 h-16 bg-[#0a1912] border border-[#133827] rounded-[18px] flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(34,197,94,0.05)]">
        ...
        {/* Text Headers */}
        <h1 className="text-[26px] font-bold text-white tracking-tight mb-2 text-center">
          Login to Dashboard
        </h1>
        <p className="text-sm text-gray-500 mb-8 text-center font-normal">
        ...
        <button
          ...
          className="w-full py-3.5 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold text-base rounded-xl transition duration-150 flex items-center justify-center gap-2.5 shadow-lg shadow-[#5865F2]/10"
        >
        ...
        <p className="text-[11px] text-gray-600 text-center mt-8 font-normal tracking-wide">
